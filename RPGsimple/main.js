...
$(document).ready(function()
{
    ...
    imgMain=new Image();
    imgMain.src="RPGsimple/images/spriteSheet.png";
    currentImgMainX=0;
    currentImgMainY=0;
    ...
    imgMountain.src="RPGsimple/images/material.png";
    imgEnemy=new Image();
    imgEnemy.src="RPGsimple/images/Enemy.png";
...
$(document).keydown(function(event)
{
    ...
    ctx.drawImage(imgMain,cutImagePositionX,0,80,123,currentImgMainX,currentImgMainY,200,200);
